// Advanced Age Calculator.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	cout << "Enter your birthdate (year/month/date) : ";
	cin >> y1 >> c1 >> m1 >> c5 >> d1;
	cout << endl;
	cout << "Enter today's date (year/month/date) : ";
	cin >> y2 >> c3 >> m2 >> c4 >> d2;
	cout << endl;
